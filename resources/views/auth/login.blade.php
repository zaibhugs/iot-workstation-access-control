...
<body>
    <section class="bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center justify-center px-6 py-8">
        <div class="w-full max-w-md">
            <a href="/register"
                class="mb-6 inline-flex items-center justify-center w-full text-2xl font-semibold text-gray-900 dark:text-white leading-none">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div>
                            ...
                            <input name="name" id="name"
                                ...
                                placeholder="admin12345" required>
                        </div>
                        <div>
